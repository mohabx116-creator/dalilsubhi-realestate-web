...
function useRealEstateSeo(pathname: string) {
  useEffect(() => {
    ...
    const seo =
      normalizedPath === '/'
        ? {
            title: 'عقارات داليل السبحي | البيع والعروض الرسمية',
            description: 'استعرض العقارات والفرص المتاحة عبر البوابة الرسمية لعقارات داليل السبحي.',
          }
        : normalizedPath === '/properties'
          ? {
              title: 'عقارات داليل السبحي | قائمة العقارات',
              description: 'تصفح قائمة العقارات المعروضة للبيع من خلال البوابة الرسمية.',
            }
          : normalizedPath === '/lands'
            ? {
                title: 'أراضي داليل السبحي | قائمة الأراضي',
                description: 'استعرض الأراضي المتاحة عبر البوابة الرسمية لعقارات داليل السبحي.',
              }
            : normalizedPath === '/sell'
              ? {
                  title: 'أعلن عن عقارك | داليل السبحي',
                  description: 'أرسل بيانات العقار أو الأرض لعرضه عبر بوابة عقارات داليل السبحي.',
                }
              : normalizedPath === '/success'
                ? {
                    title: 'تم الإرسال | داليل السبحي',
                    description: 'تم إرسال طلبك بنجاح عبر بوابة عقارات داليل السبحي.',
                  }
                : normalizedPath.startsWith('/properties/') || normalizedPath.startsWith('/lands/')
                  ? {
                      title: 'تفاصيل العقار | داليل السبحي',
        ...
        <div className="mx-auto flex h-16 w-full max-w-7xl items-center justify-between gap-3 px-4 sm:px-6 lg:px-8">
          <Link className="flex items-center gap-3" to="/">
            <span className="flex h-10 w-10 items-center justify-center overflow-hidden rounded-[14px] border border-[#ebdcb9]/80 bg-white shadow-sm">
              <img src={dalilSubhiLogo} alt="ط¯ظ„ظٹظ„ ط§ظ„ط³ط¨ط­ظٹ" className="h-full w-full object-contain mix-blend-multiply" />
            </span>
            <div className="text-right">
              <p className="text-sm font-black text-[#12221b] sm:text-base">ط¹ظ‚ط§ط±ط§طھ ط¯ظ„ظٹظ„ ط§ظ„ط³ط¨ط­ظٹ</p>
              <p className="hidden text-[10px] font-semibold text-neutral-500 sm:block">ط¨ظˆط§ط¨ط© ظ…ط®طµطµط© ظ„ط¨ظٹط¹ ط§ظ„ط¹ظ‚ط§ط±ط§طھ ط§ظ„ظ…ط¹ط±ظˆط¶ط©</p>
            </div>
          </Link>
        ...
        <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-8 text-right md:grid-cols-4" dir="rtl">
            <div className="space-y-3">
              <h3 className="text-sm font-black text-[#12221b]">ظ…ط¬ظ…ط¹ ط§ظ„ط®ط¯ظ…ط§طھ ظ„ظ„ظ…ظ†ط·ظ‚ط©</h3>
              <p className="text-xs leading-relaxed text-neutral-500">ظ…ظ†طµط© ط¢ظ…ظ†ط© ظ„ط¹ط±ط¶ ط®ط¯ظ…ط§طھ ط§ظ„ظ…ظ†ط·ظ‚ط©</p>
            </div>

            <div className="space-y-3">
              <h3 className="text-sm font-black text-[#12221b]">ظ„ظ„طھظˆط§طµظ„ ظˆط§ظ„ط¯ط¹ظ…</h3>
              <div className="mt-2 flex flex-col gap-2">
                ...
                >
                  ...
                  ط¬ط±ظˆط¨ ط§ظ„ظپظٹط³ ط¨ظˆظƒ
                </a>
              </div>
            </div>

            <div className="space-y-3">
              <h3 className="text-sm font-black text-[#12221b]">ط±ظˆط§ط¨ط· ظ…ظ‡ظ…ط©</h3>
              <ul className="space-y-2 text-xs text-neutral-500">
                ...
                <li>
                  <a
                    ...
                    className="transition-colors hover:text-[#7b5d14]"
                  >
                    ط³ظٹط§ط³ط© ط§ظ„ظ†ط´ط± ظˆط§ظ„ط¥ط¹ظ„ط§ظ†
                  </a>
                </li>
              </ul>
            </div>
          ...
          <div className="mt-8 border-t border-[#ebdcb9]/50 pt-6 text-center">
            <p className="text-[10px] text-neutral-400">آ© 2026 ظ…ط¬ظ…ط¹ ط§ظ„ط®ط¯ظ…ط§طھ ظ„ظ„ظ…ظ†ط·ظ‚ط©. ط¬ظ…ظٹط¹ ط§ظ„ط­ظ‚ظˆظ‚ ظ…ط­ظپظˆط¸ط©.</p>
          </div>
        </div>
      </footer>
    </div>
