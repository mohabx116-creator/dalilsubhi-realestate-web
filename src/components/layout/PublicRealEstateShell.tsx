        ...
        <div className="mx-auto flex h-16 w-full max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          <Link className="flex items-center gap-3" to="/">
            ...
            <div className="text-right">
              <p className="text-sm font-black text-[#1f2c22] sm:text-base">عقارات دليل السبحي</p>
              <p className="hidden text-xs font-medium text-[#5f6e62] sm:block">بوابة مخصصة لبيع العقارات والأراضي</p>
            </div>
          </Link>
