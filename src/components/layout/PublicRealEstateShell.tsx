        ...
        <div className="mx-auto flex h-16 w-full max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          <Link className="flex items-center gap-3" to="/">
            ...
            <div className="text-right">
              <p className="text-sm font-black text-fixed sm:text-base">عقارات دليل السبحي</p>
              <p className="hidden text-xs font-medium text-fixed-dim sm:block">بوابة مخصصة لبيع العقارات والأراضي</p>
            </div>
          </Link>

          <nav className="flex items-center gap-2 text-sm font-bold text-fixed">

            <Link className="hidden items-center gap-2 rounded-full px-4 py-2 transition duration-200 hover:bg-white/5 hover:text-tertiary md:inline-flex" to={ROUTES.SELL}>
              <Megaphone className="h-4 w-4 text-tertiary" />
              أعلن عن عقارك
            </Link>
            <Link className="inline-flex min-h-10 items-center gap-2 rounded-full bg-secondary px-5 py-2 text-white shadow-lg shadow-secondary/20 transition duration-200 hover:bg-secondary/90" to={ROUTES.PROPERTIES}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-right" dir="rtl">
            ...
            <div className="space-y-3">
              <h3 className="font-bold text-base text-white">عقارات المنطقة</h3>
              <p className="text-sm text-gray-400 leading-relaxed">
                منصة آمنة لعرض العقارات والأراضي
              </p>
            </div>
